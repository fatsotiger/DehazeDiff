...
from models.pytorch_msssim.LOSS import PerceptualLoss
...
class DenoisingModel(BaseModel):
    def __init__(self, opt):
        ...
        if self.is_train:
            ...
            self.Ploss = PerceptualLoss().to(self.device).eval()
    ...
    def optimize_parameters(self, step, timesteps, sde=None):
        ...
        # print(' timesteps ', timesteps.squeeze() )
        ...
        loss = self.weight * self.loss_fn(xt_1_expection, xt_1_optimum) + 0.01*self.Ploss(xt_1_expection, xt_1_optimum)
    ...
    def test(self, sde=None, input = None,hidden1=None,hidden2=None,hidden3=None, perform_ode=False, save_states=False):
        sde.set_mu(self.condition)
        ...
        with torch.no_grad():
            ...
            self.output = self.decode(input,hidden1,hidden2,latent,hidden3)
